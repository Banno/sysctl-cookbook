...
default.sysctl_accumulator["fs.file-max"] = "1000000"

# 256 KB default performs well experimentally, and is often recommended by ISVs.
default.sysctl_accumulator["net.core.rmem_default"] = "262144" 
default.sysctl_accumulator["net.core.wmem_default"] = "262144" 
...
# quickly.
default.sysctl_accumulator["net.core.rmem_max"] = "8388608" 
default.sysctl_accumulator["net.core.wmem_max"] = "8388608" 

# Allow a deep backlog for 10 Gb and bonded Gb ethernet connections
default.sysctl_accumulator["net.core.netdev_max_backlog"] = "10000" 
...
default.sysctl_accumulator["net.ipv4.tcp_rmem"] = "8192 87380 8388608" 
default.sysctl_accumulator["net.ipv4.tcp_wmem"] = "8192 87380 8388608" 
...
# low enough that memory fragmentation is unlikely to cause problems.
  ...
  default.sysctl_accumulator["net.ipv4.udp_rmem_min"] = "16384" 
  default.sysctl_accumulator["net.ipv4.udp_wmem_min"] = "16384" 

  # Ensure there's enough memory to actually allocate those massive buffers to a
  # socket.
  default.sysctl_accumulator["net.ipv4.tcp_mem"] = "8388608 12582912 16777216" 
  default.sysctl_accumulator["net.ipv4.udp_mem"] = "8388608 12582912 16777216" 
#end

# Decrease the time default value for tcp_fin_timeout connection
default.sysctl_accumulator["net.ipv4.tcp_fin_timeout"] = "30" 

# Decrease the time default value for tcp_keepalive_time connection
default.sysctl_accumulator["net.ipv4.tcp_keepalive_time"] = "1800" 

# support large window scaling RFC 1323
default.sysctl_accumulator["net.ipv4.tcp_window_scaling"] = 1 

# syn cookie flood controll enable (blocks a trivial dos)
default.sysctl_accumulator["net.ipv4.tcp_syncookies"] = 1 

# Filesystem I/O is usually much more efficient than swapping, so try to keep
# swapping low.  It's usually safe to go even lower than this on systems with
# server-grade storage.
default.sysctl_accumulator["vm.swappiness"] = "0" 

# If a workload mostly uses anonymous memory and it hits this limit, the entire
# working set is buffered for I/O, and any more write buffering would require
# swapping, so it's time to throttle writes until I/O can catch up.  Workloads
# that mostly use file mappings may be able to use even higher values.
default.sysctl_accumulator["vm.dirty_ratio"] = "50" 
...
# swap.
#default.sysctl_accumulator["vm.pagecache"] = "90" unless node.kernel.release == "2.6.9-42.ELsmp" # don't do this on this kern


# Controls the System Request debugging functionality of the kernel
default.sysctl_accumulator["kernel.sysrq"] = 1 

# reboot on panic
default.sysctl_accumulator["kernel.panic"] = 30 
